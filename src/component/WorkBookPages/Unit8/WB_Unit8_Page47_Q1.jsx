...
const ITEMS = [
  ...
  {
    id: 2,
    direct: `"We can go to the gym after studying," Lisa said.`,
    answer: "Lisa said that we could go to the gym after studying.",
    prefilled: false,
  },
  {
    id: 3,
    direct: `Drew answered, "I went on the Ferris wheel at the carnival."`,
    answer: "Drew said that he had gone on the Ferris wheel at the carnival.",
    prefilled: false,
  },
  {
    id: 4,
    direct: `Tina asked, "Will Scott take us to the movies?"`,
    answer: "Tina asked if Scott would take us to the movies.",
    prefilled: false,
  },
];
...
const WB_Unit_ReportedSpeech_E = () => {
    ...
    <div className="flex flex-col items-center p-[30px]">
      <div className="div-forall">
        ...
        <h5 className="header-title-page8 mb-8">
          ...
          Change each <span style={{ color: "orange", fontWeight: "bold" }}>direct speech</span>  given below to{" "}
          ...
          {ITEMS.map((item) => (
            <div key={item.id} style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: "10px" }}>
                ...
                <span style={{ fontSize: "16px", color: "#333" }}>{item.direct}</span>
              </div>
...
export default WB_Unit_ReportedSpeech_E;