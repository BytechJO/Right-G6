...
const QUESTIONS = [
  {
    id: 1,
    sentence: "The trainer tames the lion.",
    answer: "The lion is tamed by the trainer.",
    prefilled: false,
  },
  {
    id: 2,
    sentence: "The builder hammers the nail.",
    answer: "The nail is hammered by the builder.",
    prefilled: false,
  },
  {
    id: 3,
    sentence: "Helen helps the lady.",
    answer: "The lady is helped by Helen.",
    prefilled: false,
  },
  {
    id: 4,
    sentence: "James rides the tall, brown horse.",
    answer: "The tall, brown horse is ridden by James.",
    prefilled: false,
  },
];
...
// ── MAIN COMPONENT ──
const WB_Unit4_ActiveToPassive_F = () => {
    ...
    <div className="flex flex-col items-center p-[30px]">
      <div className="div-forall">
        ...
        <h5 className="header-title-page8 mb-10">
          ...
          Read each sentence and then change it to{" "}
...
export default WB_Unit4_ActiveToPassive_F;