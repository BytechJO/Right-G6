...
const QUESTIONS = [
  {
    prompt: 'The teacher said, "There will be a math test today."',
    correct: ["The teacher said that there would be a math test today"],
  },
  {
    prompt: 'My sister said, "I just saw a great play."',
    correct: ["My sister said that she had just seen a great play"],
  },
  {
    prompt: 'Daniel said, "Today is a good day for swimming."',
    correct: ["Daniel said that today is a good day for swimming"],
  },
];
