  ...
  return (
    <div className="space-y-4 w-full max-w-[900px] mx-auto">
      ...
      <h5 className="header-title-page8-read pb-2.5">
        ...
        In your notebook, choose one event or one subject about yourself. Using
        gerunds like the ones in the exercise, tell about yourself and what you
        do. You may want to talk about a career possibility.
      </h5>
