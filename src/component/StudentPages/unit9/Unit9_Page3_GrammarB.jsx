...
const QUESTIONS = [
  {
    prompt: "cows / wait /food",
    correct: ["The cows have been waiting for their food"],
  },
  {
    prompt: "Tilly /chase / Lolo",
    correct: ["Tilly has been chasing Lolo"],
  },
  {
    prompt: "mouse / try / to escape / from the trap",
    correct: ["The mouse has been trying to escape from the trap"],
  },
  {
    prompt: "Chris / play / board game / with his friend",
    correct: ["Chris has been playing board games with his friend"],
  },
];
  ...
  return (
    <div>
      ...
      <h5 className="header-title-page8-read mb-7">
        ...
        Write present perfect progressive sentences from the words.
      </h5>
...
export default Unit9_Page3_GrammarB;
