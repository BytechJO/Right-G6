...
const Unit9_Page2_ComprehensionA = () => {
  const correctAnswers = [
    "If the townspeople help, the thieves will probably get scared and let her go.",

    "She felt bad about Cinderella but happy to have a friend like Lori.",
  ];

  const questions = [
    "Why will the townspeople be a big help if Cinderella was stolen?",

    "How did Jenny feel before she went to sleep on the day Cinderella was stolen?",
  ];
