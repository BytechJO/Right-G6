import page_1 from "../../../assets/imgs/pages/classbook/Right 6 Unit 9 How Long Have You Been Folder/Page 76.png";
...
const Unit9_Page1 = ({ openPopup }) => {
  ...
  const captionVoc = [
...

    {
      ...
      text: "12. You only have (number) more to go.",
    },

    {
      start: 39.639,
      end: 42.34,
      text: "13. I have been dying to ...",
    },
...

    {
      ...
      text: "15. What are your plans ...?",
    },
  ];

  const wordTimingsVoc = [
    { start: 7.9, end: 9.639, text: "1. novel." },

    { start: 9.9, end: 11.8, text: "2. assigned." },

    { start: 12.0, end: 13.88, text: "3. chapter." },

    { start: 14.4, end: 16.259, text: "4. main." },

    { start: 16.7, end: 18.659, text: "5. characters." },

    { start: 19.09, end: 21.1, text: "6. perhaps." },

    { start: 21.529, end: 23.399, text: "7. discuss." },

    { start: 23.7, end: 26.059, text: "8. classmates." },

    { start: 26.3, end: 28.699, text: "9. distract." },

    { start: 29.259, end: 30.979, text: "10. deal." },

    { start: 31.539, end: 33.899, text: "11. ... in no time" },
        ...
        <svg
          ...
          onClick={() =>
            openPopup(
              "html",
              <CriticalThinking
                title={"What is Harley’s favorite part of the novel?"}
              />,
            )
          }
          style={{ overflow: "visible" }}
