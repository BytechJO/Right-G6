  ...
  return (
    <div className="space-y-4 w-full max-w-[900px] mx-auto">
      ...
      <h5 className="header-title-page8-read pb-2.5">
       ...
       Draw and color a space in or around a building. It can be your room, a favorite
room in your house, or even an outdoor area. You will be using this drawing to
help you write a paragraph about the same space.
      </h5>
