...
const Unit6_Page3_GrammarB = () => {
  const questions = [
    { id: 1, sentence: "My aunt played the violin." },
    { id: 2, sentence: "Rachel went to school there." },
    { id: 3, sentence: "They visited us in the summer." },
  ];

  const correctAnswers = [
    "My aunt used to play the violin.",
    "Rachel used to go to school there.",
    "They used to visit us in the summer.",
  ];
  ...
  return (
    <div>
      ...
      <h5 className="header-title-page8-read mb-10">
        ...
        Read each sentence and change it to a sentence using{" "}
        <span className="text-orange-500 font-bold">used to</span>.
      </h5>
